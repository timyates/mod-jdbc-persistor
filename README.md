...
Also, not currently Asynchronous (see the [worker_queue_backing](https://github.com/timyates/mod-jdbc-persistor/tree/worker_queue_backing) branch for efforts in this direction)
